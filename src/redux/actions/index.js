...
export const clearTicketStatusTypesOnUnmout = () => 
    async dispatch => {
        dispatch({type: FETCH_TICKET_STATUS_TYPES, payload: null})
        
    }

export const clearTicketsOnUnmount = () => 
    async dispatch => {
        dispatch({type: FETCH_TICKETS, payload: null})
    }