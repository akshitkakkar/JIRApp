...
const ProjectDetails = ({match, fetchTicketStatusTypes, fetchTickets, ticketStatusTypesTest, ticketsTest}) => {
    ...
    return(
        <div className="container">
            { ticketStatusTypesTest && ticketsTest &&
            <CardGroup>
                {renderIssueBoard()}
            </CardGroup>}
...
const mapStateToProps = ({ticketStatusTypes, tickets}) => {
    return {
        ticketStatusTypesTest: ticketStatusTypes,
        ticketsTest: tickets
    }
}
